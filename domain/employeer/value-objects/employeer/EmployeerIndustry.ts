...
export default class EmployeerIndustry implements IValueObject {
    ...
    public static create(industry:string){
        if(industry == undefined || industry == null){
            throw new EmployeerEmptyIndustryException('La industria no puede estar vacia')
        }

        if(typeof industry != "string"){
            throw new EmployeerInvalidIndustryException('La industria tiene que ser un string');
        }
