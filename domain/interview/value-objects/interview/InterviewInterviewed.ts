...
import EmptyInterviewInterviewedException from '../../exceptions/Interview/InterviewEmptyInterviewedException';
...
export default class InterviewInterviewed implements IValueObject {
    ...
    public static create(interviewed: string) {
        if(interviewed === '' || interviewed === ' ' || interviewed == undefined || interviewed == null){
