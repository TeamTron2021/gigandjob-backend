...
import EmptyInterviewInterviewerException from '../../exceptions/Interview/InterviewEmptyInterviewedException';
...
export default class InterviewInterviewer implements IValueObject {
    ...
    public static create(interviewer: string) {
        if(interviewer === '' || interviewer === ' ' || interviewer == undefined || interviewer == null){
