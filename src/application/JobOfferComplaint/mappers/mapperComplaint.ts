...
export class mappersComplaint {
  public convertDtoToDomainCreate(
    domainComplaint: CreateJobOfferComplaintDtoIn,
  ) /*:JobOfferComplaint*/ {
  ...
  public convertDtoToDomainAccept(
    domainComplaint: UpdateJobOfferComplaintDtoIn,
    idComplaint: ComplaintIdDtoInOut,
  ) {
    ...
    if (
      domainComplaint.acceptedOrRejected == null ||
      domainComplaint.acceptedOrRejected == false
    ) {
  ...
  public convertDtoToDomainReject(
    domainComplaint: UpdateJobOfferComplaintDtoIn,
    idComplaint: ComplaintIdDtoInOut,
  ) {
    const id = JobOfferComplaintId.create(idComplaint.id);
  ...
  public convertDtoToDomainCreateJobOffferid(
  ...
  public convertDomainToDtoCreateJobOffferid(
    idJobOffer: JobOfferId,
  ): JobOfferIdDtoInOut {
    const idOfferSC = new JobOfferIdDtoInOut(idJobOffer.getId());
    return idOfferSC;
  }

  public convertDomainToDto(
    domainComplaint: JobOfferComplaint,
  ): CreateJobOfferComplaintDtoOut {
