...
export default class EmployeerNotification {
  ...
  public static register(
    ...
    employeerNotification.eventRecorder.push(
      new EmployeerRegistered(subject, content),
    );
  ...
  public sendSuspension() {
    this.eventRecorder.push(
      new EmployeerSuspendedNotification(
        this.Employeer.getId(),
        this.subject,
        this.content,
      ),
    );
  ...
  public sendReactivation() {
    this.eventRecorder.push(
      new EmployeerReactivedNotification(
        this.Employeer.getId(),
        this.subject,
        this.content,
      ),
