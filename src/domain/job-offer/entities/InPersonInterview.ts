...
export default class InPersonInterview<S extends InterviewStatus>
  implements IInterview
{
  ...
  static create(
    ...
    const inPersonInterview = new InPersonInterview(
      title,
      description,
      date,
      interviewed,
    ...
    inPersonInterview.addEvent(
      new InPersonInterviewCreated(
        Id,
        title,
        description,
        date,
  ...
  public rescheduledInterview(
    ...
    interview.eventRecorder.push(
      new InPersonInterviewRechedule(
        this.Id,
        this.date,
        InterviewStatus.rescheduled,
        this.direction,
