...
import InterviewNotificationIdException from '../../../exceptions/Interview/Interview/interview-notification/InterviewNotificationIdException';
...
export default class InterviewNotificationId implements IValueObject {
  ...
  public static create(id: string): InterviewNotificationId {
    if (id === '' || id === ' ' || id == undefined || id == null) {
      throw new InterviewNotificationIdException(
