...
import NotificationEmptyContentException from '../../../../exceptions/Interview/Interview/interview-notification/NotificationEmptyContentException';
import NotificationInvalidContentException from '../../../../exceptions/Interview/Interview/interview-notification/NotificationInvalidContentException';
...
export default class NotificationContent implements IValueObject {
  ...
  public static create(content: string) {
    ...
    if (typeof content != 'string') {
      throw new NotificationInvalidContentException(
