...
import NotificationEmptySubjectException from '../../../../exceptions/Interview/Interview/interview-notification/NotificationEmptySubjectException';
import NotificationInvalidSubjectException from '../../../../exceptions/Interview/Interview/interview-notification/NotificationInvalidSubjectException';
  ...
  public static create(subject: string) {
    if (subject == null || subject == undefined) {
      throw new NotificationEmptySubjectException(
        'El motivo no puede estar vacio',
      );
    }
