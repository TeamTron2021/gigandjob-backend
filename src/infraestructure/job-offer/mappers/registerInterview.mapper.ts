...
import InterviewDto from 'src/application/job-offer/ports/interview.dto';
...
export default class RegisterInterviewMapper {
  ...
  public static convertToInterviewTitle(title: string): InterviewTitle {
    return InterviewTitle.create(title);
  }
  public static convertToInterviewDescription(description: string): InterviewDescription {
    return InterviewDescription.create(description);
  }
  public static convertToInterviewDate(date: Date): InterviewDate {
