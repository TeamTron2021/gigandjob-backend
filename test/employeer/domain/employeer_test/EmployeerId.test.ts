import EmptyEmployeerIdException from '../../../../src/domain/employeer/exceptions/employeer/EmptyIdEmployeerException';
...
describe('Testing EmployeerId value object', () => {
  it('Should throw an Empty EmployeerId error', () => {
    const id: any = null;
    expect(() => EmployeerId.create(id)).toThrow(
      new EmptyEmployeerIdException('El id del empleador no puede estar vacio'),
    );
  });
  it('Should throw an Empty EmployeerId error', () => {
    const id: any = '      ';
