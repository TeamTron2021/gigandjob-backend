import EmployeerEmptyIndustryException from '../../../../src/domain/employeer/exceptions/employeer/EmployeerEmptyIndustryException';
import EmployeerInvalidIndustryException from '../../../../src/domain/employeer/exceptions/employeer/EmployeerInvalidIndustryException';
...
describe('Testing employeerIndustry value object', () => {
  it('Should throw an empty Industry error ', () => {
    ...
    expect(() => EmployeerIndustry.create(industry)).toThrow(
      new EmployeerEmptyIndustryException('La industria no puede estar vacia'),
    );
  });
  it('Should throw an empty Industry error ', () => {
  ...
  it('Should throw an empty Industry error ', () => {
    ...
    expect(() => EmployeerIndustry.create(industry)).toThrow(
      new EmployeerInvalidIndustryException(
