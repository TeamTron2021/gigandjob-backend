...
describe('Testing EmployeerLocalization value object',()=>{
    it('Should throw an emptyLocalization error', ()=>{
        ...
        expect(()=> EmployeerLocalization.create(latitude, longitude)).toThrow(new  EmployeerEmptyLocalizationException(
    ...
    it('Should return a EmployeerLocalization instance',()=>{
        ...
        const isEmployeerLocalization = employeerLocalization instanceof EmployeerLocalization; 
