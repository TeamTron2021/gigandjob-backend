import EmployeerEmptyRifException from '../../../../src/domain/employeer/exceptions/employeer/EmployeerEmptyRifException';
import EmployeerInvalidRifException from '../../../../src/domain/employeer/exceptions/employeer/EmployeerInvalidRifException';
...
describe('Testing EmployeerRif value object', () => {
  it('Should throw an empty rif error', () => {
    ...
    expect(() => EmployeerRif.create(rif)).toThrow(
      new EmployeerEmptyRifException('El rif no puede estar vacio'),
    );
  });
  it('Should throw an empty rif error', () => {
    const rif: any = null;
  ...
  it('Should throw an empty rif error', () => {
    const rif: any = '      ';
    expect(() => EmployeerRif.create(rif)).toThrow(
      new EmployeerInvalidRifException('El rif introducido no es valido'),
    );
  });
  it('Should throw an empty rif error', () => {
    const rif: any = 90;
