...
describe('Value Object JobOfferComplaintIssue', () =>{
	test('Should return a error: JobOfferComplaintIssue ',() =>{
		...
		expect(() => JobOfferComplaintMessage.create(message)).toThrowError('El message de JobOfferComplaintMessage no puede ser undefined o null');
	})
    ...
    test('Should return the happy path',() =>{
		...
		expect(JobOfferComplaintMessage.create(message)).toBeInstanceOf(JobOfferComplaintMessage);
	})
})
