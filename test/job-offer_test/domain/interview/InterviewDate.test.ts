...
describe('Testing value object InterviewDate',()=>{
    it('Should throw an missing date error',()=>{
        ...
        expect(()=> InterviewDate.create(initialDate, finalDate)).toThrow(new InterviewMissingDateException(
    ...
    it('Should throw an invalid date error', ()=>{
        ...
        expect(()=> InterviewDate.create(initialDate, finalDate)).toThrow(new InterviewInvalidDateException(
