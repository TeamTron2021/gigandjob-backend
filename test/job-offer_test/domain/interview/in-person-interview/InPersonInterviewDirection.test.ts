...
describe('Testing value object InPersonInterviewDirection',() =>{
    it('Should return an empty offerDescriptionError', ()=>{
        expect(()=>InPersonInterviewDirection.create(' ')).toThrowError(new InterviewEmptyDescriptionException(
    ...
    it('Should return an empty offerDescriptionError', ()=>{
        ...
        expect(()=>InPersonInterviewDirection.create(description)).toThrowError(new InterviewEmptyDescriptionException(
            'La Direccion de la Entrevista no puede estar vacia'
        ))
    });
    it('Should return a InPersonInterviewDirection instance', () =>{
        const description ='Direccion generica de una entrevista presencial'; 
        const inPersoninterviewUrlMInPersonInterviewDirection = InPersonInterviewDirection.create(description); 
        const isDescription = inPersoninterviewUrlMInPersonInterviewDirection instanceof InPersonInterviewDirection; 
