import InterviewNotificationId from '../../../../../src/domain/job-offer/value-objects/Interview/interview/InterviewNotificationId';
import InterviewNotificationIdException from '../../../../../src/domain/job-offer/exceptions/Interview/Interview/interview-notification/InterviewNotificationIdException';
...
describe('Value Object InterviewNotificationId Tests', () => {
  test('Should return an interview notification id exception because of an empty value as parameter', () => {
    ...
    expect(() => {
      ...
      new InterviewNotificationIdException(
        'El ID de la notificación no puede ser vacío',
      ),
    );
  });
