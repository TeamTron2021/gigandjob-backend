import JobOfferLikedId from '../../../../src/domain/job-offer/value-objects/jobOfferLike/JobOfferLikeId';
...
describe('Value Object JobOfferLikedId', () => {
  test('Should return a error: likeIDEmpty', () => {
    const id: any = null;
    expect(() => JobOfferLikedId.create(id)).toThrowError(
  ...
  test('Should return error structure uuid', () => {
    const id = 'a24a6ea4-ce75-4665-a070'; // Correct structure "a24a6ea4-ce75-4665-a070-57453082c256"
    expect(() => JobOfferLikedId.create(id)).toThrowError(
      'El id de JobOfferLike no posee la estructura correcta',
    );
  });
