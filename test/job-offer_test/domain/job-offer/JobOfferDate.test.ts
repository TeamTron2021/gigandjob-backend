...
describe('Testing value object JobOfferDate',()=>{
    it('Should throw an missing date error',()=>{
        ...
        expect(()=> JobOfferDate.create(initialDate, finalDate)).toThrow(new JobOfferMissingDateException(
    ...
    it('Should throw an invalid date error', ()=>{
        ...
        expect(()=> JobOfferDate.create(initialDate, finalDate)).toThrow(new JobOfferInvalidDateException(
