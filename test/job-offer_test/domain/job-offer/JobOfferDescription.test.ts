import JobOfferEmptyDescriptionException from "../../../../domain/job-offer/exceptions/JobOffer/JobOfferEmptyDescriptionException";
...
describe('Testing value object JobOfferDescription',() =>{
    it('Should return an empty offerDescriptionError', ()=>{
        expect(()=>JobOfferDescription.create(' ')).toThrowError(new JobOfferEmptyDescriptionException(
    ...
    it('Should return an empty offerDescriptionError', ()=>{
        ...
        expect(()=>JobOfferDescription.create(description)).toThrowError(new JobOfferEmptyDescriptionException(
            'La oferta tiene que tener una descripcion'
        ))
    });
