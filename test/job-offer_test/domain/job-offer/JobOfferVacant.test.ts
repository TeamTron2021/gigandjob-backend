import JobOfferVacantInvalid from '../../../../src/domain/job-offer/exceptions/JobOffer/JobOfferVacantInvalid';
...
describe('Testing value object JobOfferVacant', () => {
  it('Should throw invalid vacant error ', () => {
    expect(() => JobOfferVacant.create(-50)).toThrow(
      new JobOfferVacantInvalid('las vacantes no puede ser menores que 0'),
    );
  });
