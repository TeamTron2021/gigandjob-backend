...
import NotificationEmptySubjectException from '../../../../../src/domain/job-offer/exceptions/JobOffer/JobOfferNotificationSuject';
import { JobOfferNotificationSubject } from '../../../../../src/domain/job-offer/value-objects/JobOffer/JobOfferNotificationSubject';
...
describe('Testing notification subject value object', () => {
  test('Should throw an empty notification subject error', () => {
    ...
    expect(() => JobOfferNotificationSubject.create(subject)).toThrow(
