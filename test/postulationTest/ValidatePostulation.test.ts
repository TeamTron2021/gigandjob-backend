import { ValidateUserCanPostulate } from '../../src/domain/job-offer/domain-service/jobOffer/ValidateUserCanPostulateService';
...
describe('Validate User can Apply to JobOffer', () => {
  test('User can apply to the job offer', () => {
    ...
    expect(jobOffer.vacant.getVacants() > expectVacant.getVacants()).toEqual(
      true,
    );
