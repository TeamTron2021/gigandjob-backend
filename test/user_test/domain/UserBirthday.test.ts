import { UserBirthdayEmpty } from '../../../src/domain/user/errors/UserBirthdayEmpty.error';
import { UserBirthdayInvalid } from '../../../src/domain/user/errors/UserBirthdayInvalid.error';
...
describe('Value Object UserBirthday', () => {
  ...
  test('Should return a error: UserBirthdayInvalid', () => {
    ...
    expect(() => new UserBirthday(future)).toThrowError(
      new UserBirthdayInvalid(),
    );
  });
